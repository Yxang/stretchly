...
- [042-20260507-0300-chronicler-direct-dev-governance.md](042-20260507-0300-chronicler-direct-dev-governance.md) — 治理：Chronicler 直推 dev 的规则-实践不一致（04db37f/a61a610 直推 dev vs knowledge 文档禁止规则），元治理观察 + 差异分析 + 3 项选项（A: 知识文档加例外 / B: chronicler 启用 worktree / C: git-workflow 精细化）
- [043-20260507-0330-v1.22-release-retro.md](043-20260507-0330-v1.22-release-retro.md) — v1.22 Release Retrospective：5 bug 闭环（T-201..T-205 squash commits）、3 治理 findings（dev-log 035/041/042 + C+ ruling）、C+ v1.23 action items（git-workflow.md / evidence 边界 / agent 写入位置）、模型实绩 vs 预算（18 agents：1 opus + 17 sonnet）、trunk HEAD 4855a6a / tag v1.22 / 用户 L4 PASS 2026-05-07
